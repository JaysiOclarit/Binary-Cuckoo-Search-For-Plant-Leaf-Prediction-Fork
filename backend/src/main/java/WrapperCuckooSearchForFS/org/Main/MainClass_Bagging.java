...
public class MainClass_Bagging {
    public static void main(String[] args) throws IOException {
        ...
        var dataPath = "C:\\Users\\janch\\IdeaProjects\\Binary-Cuckoo-Search-For-Plant-Leaf-Prediction\\backend\\Entire Data Folder\\Philippine After IBCS-FS\\Philippine After FS(2).csv";
