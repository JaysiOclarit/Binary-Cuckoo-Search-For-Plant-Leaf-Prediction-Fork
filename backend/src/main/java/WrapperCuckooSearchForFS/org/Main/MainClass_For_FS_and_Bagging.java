...
public class MainClass_For_FS_and_Bagging {
    public static void main(String[] args) throws IOException {
        // read the data
        var dataPath = "C:\\Users\\janch\\IdeaProjects\\Binary-Cuckoo-Search-For-Plant-Leaf-Prediction\\backend\\Entire Data Folder\\Original Dataset\\Swedish Leaf data.csv";
        ...
        new CSVSaver().save(Paths.get(System.getProperty("user.dir") + "\\Swedish After FS(2).csv"),
                SFDS,
                "Class");
