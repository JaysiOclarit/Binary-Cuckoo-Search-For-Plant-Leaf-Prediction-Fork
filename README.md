...
│   ├── src/
│   │   ├── components/                       # LeafClassifier, SideBySideBenchmark, CuckooSimulator,
│   │   │                                       BotanicalEncyclopedia, ThesisAnalytics, DefenseWizard
...
```bash
cd backend
& "C:\Program Files\JetBrains\IntelliJ IDEA Community Edition 2025.1\plugins\maven\lib\maven3\bin\mvn.cmd" compile exec:java "-Dexec.mainClass=WrapperCuckooSearchForFS.org.SpringBootApp"
```
